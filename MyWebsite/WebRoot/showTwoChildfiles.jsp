  ...
  <div class="tableContainer">	
	<div id="mainContent" style="width:100%; background:#fff none repeat scroll 0% 0%; " class="tablePanel"> 
		...
		<div class="editPanelQuery">
		  <form name="childinfoquery" action="QueryChildfiles"  method="post">
                   <div class="field">
		...
		<div class="editPanel" style="padding-top:7px;">
		     <table class="tab" width="80%" align="center" style="font-size:19px;font-family:'楷体';">
                <tr>
                 ...
                 <!-- 幼儿基本信息展示 -->
                   <td>${childinfo.childname}</td>
                   <td>${childinfo.childgender}</td>
                   <td><fmt:formatDate value="${childinfo.childbirth}" type="date" dateStyle="long"/></td>
                   <td>${childinfo.idnum}</td>
                 </tr>
             </table>
             <table class="tab" width="80%" align="center" style="font-size:19px;font-family:'楷体';">
                <tr>
